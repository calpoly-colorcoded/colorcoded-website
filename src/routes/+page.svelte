...
<div class="container h-screen flex mx-auto my-full justify-center items-center">
	<div class="text-center flex w-screen flex-col items-center space-y-10 ">
	

		<TabGroup flex="flex-1 w-auto" justify="justify-center" >
			<!-- <Tab bind:group={tabSet} name="tab1" value={0}>
				<svelte:fragment slot="lead">(About Us)</svelte:fragment>
				<span>(label 1)</span>
			</Tab> -->
			<Tab bind:group={tabSet} name="tab2" value={0} flex='w-auto'>About Us</Tab>
